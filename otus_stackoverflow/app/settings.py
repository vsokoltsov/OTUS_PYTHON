"""
Django settings for otus_stackoverflow project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'app.utils.processors.trending_questions'
            ],
        },
    },
]
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'app.utils.jwt_authentication.JWTAuthentication',
    )
}
