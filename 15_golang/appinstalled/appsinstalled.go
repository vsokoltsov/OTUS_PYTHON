...
func (*UserApps) Descriptor() ([]byte, []int) {
	return fileDescriptor_appsinstalled_1a362be686fdcf77, []int{0}
}
...
func init() { proto.RegisterFile("appsinstalled.proto", fileDescriptor_appsinstalled_1a362be686fdcf77) }

var fileDescriptor_appsinstalled_1a362be686fdcf77 = []byte{
